    ...
    <div className="col-lg-4">
        <div className="card mb-5 mb-lg-0">
          <div className="card-body">
            ...
            <hr/>
            <ul className="fa-ul">
              <li className={props.data.userEnabler?"fw:bold":"text-muted"}><span className="fa-li"><i className={props.data.userEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.data.users}</li>
              ...
              <li className={props.data.storageEnabler?"":"text-muted"}><span className="fa-li"><i className={props.data.publicProjectsEnabler?"fas fa-check":"fas fa-times"}></i></span>{props.data.publicProjects}</li>
              ...
              <li className={props.data.phoneSupportEnable?"":"text-muted"}><span className="fa-li"><i className={props.data.phoneSupportEnable?"fas fa-check":"fas fa-times"}></i></span>{props.data.phoneSupport}</li>
